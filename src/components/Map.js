import { canvas, Map as DDDMap, random } from 'dddrawings';

export default class Map {
  constructor(container) {
    this.data = [];
    this.holes = [];
    this.base = canvas(container);
    ...
    this.manager = new DDDMap(this.managerOptions);
  }
  ...
  reload(w, h) {
    ...
    this.manager.updateSize(this.stage.w, this.stage.h, this.managerOptions.zoom);
  }
